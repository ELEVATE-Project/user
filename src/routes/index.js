...
module.exports = (app) => {
	...
	app.all('/userlog/:version/:controller/:method', validator, router)
	app.all('/userlog/:version/:controller/:file/:method', validator, router)
	app.all('/userlog/:version/:controller/:method/:id', validator, router)
	app.all('/userlog/:version/:controller/:file/:method/:id', validator, router)
