...
## Setup Mentoring Services without docker
...
Go to https://github.com/ELEVATE-Project/mentoring From the code tab copy the link. Using that link clone the repository into your local machine.
...
### 3. Run MongoDB locally
    ...
    specify the mongo port and IP in the .env application takes the DB as specified in the .env
...
https://dev.elevate-apis.shikshalokam.org/mentoring/api-doc
