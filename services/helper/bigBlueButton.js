...
module.exports = class SessionsHelper {
    static async createMeeting(meetingId,meetingName,attendeePW,moderatorPW) {
        try {
            ...
            let query = "name=" + meetingName + "&meetingID=" + meetingId + "&record=true" + "&autoStartRecording=true" + "&meetingKeepEvents=true" + "&meta_endCallbackUrl=" + endMeetingCallBackUrl + "&attendeePW=" + attendeePW + "&moderatorPW=" + moderatorPW;
