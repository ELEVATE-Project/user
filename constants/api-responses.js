module.exports = {
  ...
  USER_CREATED_SUCCESSFULLY:
    "Sign-up successful, Please wait while logging in.",
  ...
  OTP_SENT_SUCCESSFULLY:
    "OTP has been sent to your registered email ID. Please enter the number to update your password.",
  REGISTRATION_OTP_SENT_SUCCESSFULLY:
    "OTP has been sent to your registered email ID. Please enter the otp to complete the registration process.",
  ...
  USER_ROLE_UPDATED:
    "You have been logged out of your account due to change in platform role. Please login again.",
  UNABLE_TO_SEND_OTP: "Unable to send otp, may be redis server is down.",
  RESET_PREVIOUS_PASSWORD:
    "Please enter a new password, that has not been used before",
